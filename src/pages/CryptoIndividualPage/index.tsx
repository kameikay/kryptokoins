    ...
    <Container timeSelected={timeSelected}>
      ...
      <div className="time">
        ...
        <div className="time-data">
          <p>
            Variação:{" "}
            <span>{formatPercentage(specficData?.price_change_pct)}</span>
          </p>

          <p>
            Variação de valor:{" "}
            <span>{formatCurrency(specficData?.price_change)}</span>
          </p>

          <p>
            Volume de transações:{" "}
            <span>{formatCurrency(specficData?.volume_change)}</span>
          </p>
        </div>
      </div>
    </Container>
